...
export function SmokeButton(props: SmokeButtonProps) {
  return (
    <div className="border-4 border-purple-500 rounded-lg h-[28rem] md:h-[38rem] lg:h-[42rem] p-4 md:w-2/5 my-4 mx-4 md:ml-4 lg:ml-8 flex flex-col items-center justify-center">
      <button
